import {BadRequestException, Body, Controller, Get, HttpCode, Ip, Param, Post, Query, Res,} from '@nestjs/common';
...
import {ForgotPasswordDto, SendForgotPasswordDto,} from './dtos/forgot-password.dto';
